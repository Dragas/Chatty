...
{
    override val endpoint: DiscordEndpoint by lazy()
    {
        DiscordEndpoint()
    }
    override val router: DiscordRouter = DiscordRouter(responseChannel)
    ...
    {
        super.initialize()
        router.consume(ConnectionController::class.java)
    }
